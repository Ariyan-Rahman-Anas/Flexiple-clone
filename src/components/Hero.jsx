...
const Hero = () => {
  return (
      <div className="bg-gradient-to-b from-blue-700 to-purple-900 text-white text-center min-h-[65vh] flex flex-col items-center justify-center ">
          <div className="w-full md:w-[55%] space-y-8 pt-28 ">
              <h1 className="text-4xl font-bold tracking-wider">Hire .NET Developers: Affordable, Dedicated .NET Experts in 72 hours</h1>
